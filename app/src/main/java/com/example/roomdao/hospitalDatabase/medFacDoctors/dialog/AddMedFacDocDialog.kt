...
class AddMedFacDocDialog(val viewModel: HospitalViewModel, private val medFacList: List<MedFacility>, private val doctorList: List<Doctor>): DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext(), R.style.AlertDialogCustom)
                ...
                .setPositiveButton("add"){_,_ ->
                    ...
                    viewModel.addMedFacDoc(listOf(MedFacDoctor(0, medFacId, doctorId)))
                }
